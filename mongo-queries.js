...
/*var CorrectiveActions       = require('./mongoose_models/correctiveActions'),
    Departments       = require('./mongoose_models/departments'),
    Courses           = require('./mongoose_models/courses')
    Provider           = require('./mongoose_models/provider')
...
var schemas = {
  correctiveActions: require('./mongoose_models/correctiveActions'),
  courses:           require('./mongoose_models/courses'),
  ...
  providers:         require('./mongoose_models/provider'),
  resources:         require('./mongoose_models/resource'),
  laboratoryTest:    require('./mongoose_models/laboratoryTest'),
