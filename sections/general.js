...
module.exports = function ( server ) {
  server.get( '/:schema', basicValidations, function ( req, res ) {
    var condition       = {},
  ...
  server.del( '/:schema', basicValidations, function ( req, res ) {
  ...
  server.put( '/:schema', basicValidations, function ( req, res ) {
    var schema      = req.params.schema,
